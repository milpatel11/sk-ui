    ...
    return (
        <Box>
            ...
            <Typography variant="body1" paragraph>
                Unified platform concept combining ride‑hailing, courier parcel delivery, food & grocery delivery, and
                multi‑leg logistics orchestration. This is a placeholder dashboard; data services are not yet
                integrated.
            </Typography>
            <Stack spacing={2}>
                ...
                <Paper variant="outlined" sx={{p: 2}}>
                    ...
                    <Typography variant="body2">Scaffold only. Next steps: define domain types (Driver, Vehicle,
                        FleetZone, Trip, DeliveryOrder), mock endpoints, then surface KPI tiles (active drivers, open
                        trips, on-time %).</Typography>
                </Paper>
            </Stack>
        </Box>
    );
