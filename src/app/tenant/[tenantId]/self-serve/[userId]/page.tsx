...
export default function SelfServePage() {
  ...
  return (
    <Box maxWidth={800} mx="auto">
      ...
      <Typography variant="body2" color="text.secondary" mb={3}>Manage profile, credentials & preferences.</Typography>
      <Paper variant="outlined" sx={{ p:3 }}>
        ...
        <Typography variant="body2" mt={2}>Form sections (profile update, password reset, addresses, etc.) go here.</Typography>
