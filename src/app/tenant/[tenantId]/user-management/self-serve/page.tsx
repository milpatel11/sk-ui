...
export default function SelfServePage() {
    ...
    return (
        <Box maxWidth={800} mx="auto" py={2}>
            ...
            <Typography variant="body2" color="text.secondary" mb={3}>Update password and manage profile addresses
            ...
            <Stack spacing={3}>
                ...
                <Paper sx={{p: 2}}>
                    ...
                    <Stack spacing={2}>
                        ...
                        <Button variant="contained" onClick={requestPasswordReset} disabled={loading}>Request password
                            reset</Button>
                    </Stack>
                </Paper>
            </Stack>
