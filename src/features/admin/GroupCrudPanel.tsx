...
export const GroupCrudPanel: React.FC<GroupCrudPanelProps> = ({title = 'Global Groups', filterScope = null, hideTitle = false}) => {
    ...
    return (
        <Box>
            {!hideTitle && <Typography variant="h5" gutterBottom>{title}</Typography>}
